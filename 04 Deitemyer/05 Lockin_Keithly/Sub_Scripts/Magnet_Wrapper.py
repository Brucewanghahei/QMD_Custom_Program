...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.setWindowTitle("Magnetic Sweep with Current Bias Lock-in")
        ...
        self.ui.tabWidget_visa.setTabText(2, "Magnet")
        ...
        self.input_string.append("06 CurrBias Lock-in Sens: 1e-3\n")
        self.input_string.append("07 Current Bias Resistor: 1.009e9\n")
        self.input_string.append("08 Lock-in Output Voltage: 5\n")
        self.input_string.append("09 Additional Lock-in Volt Gain: 1\n")
        self.input_string.append("10 Averaging: 1\n\n")
...
class Collect_data(QThread):
    ...
    def input(self, ui, instruments, curves, curveWidgets, go_on, inputted_data, comments, array_sweep, inputted_string, input_string):
        ...
        self.averaging = float(inputted_data[10])
        ...
        while True:
            if self.go_on:
                ...
                if self.pause_collecting:
                    ...
                    total_volt = float(0.0)
                    
                    for i in range(0, int(self.averaging)):
                        Agilent().read_data_write(self.lockin_visa)
                        total_volt = total_volt + float(Agilent().read_data_read(self.lockin_visa))
                        print i, total_volt
                    
                    DeviceVolt = total_volt/float(self.averaging)
                    print "DeviceVolt", DeviceVolt, self.averaging
