...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.input_string.append("04 Lock-in Sense: 200e-6\n")
        self.input_string.append("05 Pre-Amp Gain: 100\n")
        self.input_string.append("06 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("07 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("08 Output Voltage(mV): 50\n")
        ...
        self.input_string.append("19 Device 2 Measure (y/n): y\n")
        self.input_string.append("20 Lock-in Sense: 200e-6\n")
        self.input_string.append("21 Pre-Amp Gain: 100\n")
        self.input_string.append("22 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("23 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("24 Output Voltage(mV): 50\n")
        ...
        self.input_string.append("35 Device 3 Measure (y/n): y\n")
        self.input_string.append("36 Lock-in Sense: 200e-6\n")
        self.input_string.append("37 Pre-Amp Gain: 100\n")
        self.input_string.append("38 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("39 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("40 Output Voltage(mV): 50\n")
...
class Collect_data(QThread):
    ...
    def Reading(self, device, input_volt, num, Round):
        ...
        if device == "Yokogawa1":
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa1", [self.total_during, self.during, input_volt, current, resistance, self.Data[2][15]])
        ...
        # Device 2
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa2", [self.total_during, self.during, input_volt, current, resistance, self.Data[3][15]])
        ...
        # Device 3
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa3", [self.total_during, self.during, input_volt, current, resistance, self.Data[4][15]])
