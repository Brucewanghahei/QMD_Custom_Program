...
class MyForm(QMainWindow):
    ...
    def __init__(self, parent = None):
        ...
        self.connect(self.ui.pushButton_select_7, SIGNAL('clicked()'), lambda : self.Select("visa7", self.visa7, self.ui.comboBox_visa_7, self.ui.label_visa_7, [self.ui.pushButton_select_7, self.ui.pushButton_close_7], baud = 115200))
        ...
        self.curve_1 = self.make_curveWidgets(self.ui.curvewidget_1, "b", "blue", titles = ["Magnet", "Step", "Field (T)"])
        self.curve_1_update = self.make_curveWidgets(self.ui.curvewidget_1, "red", "red", titles = ["Magnet", "Step", "Field (T)"])
        ...
        self.setWindowTitle("Magnet Sweep with Voltage Bias Lock-in")
        
        self.input_string = []
        self.input_string.append("00 Run_Number: 01\n\n")
        
        self.input_string.append("01 Start Field(T): 0\n")
        self.input_string.append("02 Field Sweep(T): 0.001\n")
        self.input_string.append("03 Record Step Field(T): 0.001\n")
        self.input_string.append("04 End Field(T): 0.01\n")
        self.input_string.append("05 Double Linear & Collect(y/n): y\n\n")
        self.input_string.append("06 Yokogawa Ramp TimeStep(s): 0.2\n")
        self.input_string.append("07 Yokogawa Collect TimeStep(s): 1.8\n\n")
        
        self.input_string.append("08 Device 1 Measure (y/n): y\n")
        self.input_string.append("09 Lock-in Sense: 200e-6\n")
        self.input_string.append("10 Pre-Amp Gain: 100\n")
        self.input_string.append("11 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("12 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("13 Output Voltage(mV): 50\n")
        self.input_string.append("14 Initial Ramp Start(mV): 0\n")
        self.input_string.append("15 Initial Ramp End(mV): -5000\n")
        self.input_string.append("16 Initial Ramp Step(mV): -100\n")
        self.input_string.append("17 Collecting Start(mV): -5000\n")
        self.input_string.append("18 Collecting Stop(mV): 5000\n")
        self.input_string.append("19 Collecting Step(mV): 100\n")
        self.input_string.append("20 Final Ramp Start(mV): 5000\n")
        self.input_string.append("21 Final Ramp Stop(mV): 0\n")
        self.input_string.append("22 Final Ramp Step(mV): -100\n")
        self.input_string.append("23 File Name: Device4\n\n")
        
        self.input_string.append("24 Device 2 Measure (y/n): y\n")
        self.input_string.append("25 Lock-in Sense: 200e-6\n")
        self.input_string.append("26 Pre-Amp Gain: 100\n")
        self.input_string.append("27 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("28 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("29 Output Voltage(mV): 50\n")
        self.input_string.append("30 Initial Ramp Start(mV): 0\n")
        self.input_string.append("31 Initial Ramp End(mV): -5000\n")
        self.input_string.append("32 Initial Ramp Step(mV): -100\n")
        self.input_string.append("33 Collecting Start(mV): -5000\n")
        self.input_string.append("34 Collecting Stop(mV): 5000\n")
        self.input_string.append("35 Collecting Step(mV): 100\n")
        self.input_string.append("36 Final Ramp Start(mV): 5000\n")
        self.input_string.append("37 Final Ramp Stop(mV): 0\n")
        self.input_string.append("38 Final Ramp Step(mV): -100\n")
        self.input_string.append("39 File Name: Device5\n\n")
    
        self.input_string.append("40 Device 3 Measure (y/n): y\n")
        self.input_string.append("41 Lock-in Sense: 200e-6\n")
        self.input_string.append("42 Pre-Amp Gain: 100\n")
        self.input_string.append("43 Lock-in Resistor(Ohms): 1e6\n")
        self.input_string.append("44 Yokogawa Resistor(Ohms): 1e5\n")
        self.input_string.append("45 Output Voltage(mV): 50\n")
        self.input_string.append("46 Initial Ramp Start(mV): 0\n")
        self.input_string.append("47 Initial Ramp End(mV): -5000\n")
        self.input_string.append("48 Initial Ramp Step(mV): -100\n")
        self.input_string.append("49 Collecting Start(mV): -5000\n")
        self.input_string.append("50 Collecting Stop(mV): 5000\n")
        self.input_string.append("51 Collecting Step(mV): 100\n")
        self.input_string.append("52 Final Ramp Start(mV): 5000\n")
        self.input_string.append("53 Final Ramp Stop(mV): 0\n")
        self.input_string.append("54 Final Ramp Step(mV): -100\n")
        self.input_string.append("55 File Name: Device9\n")
    ...
    def Select(self, signal, visa_chosen, comboBoxVisa, lineEditVisa, selectClose, baud = None):
        ...
        if visa_check == True:
            ...
            if signal == "visa1":
                ...
                if first_name == "AMERICAN MAGNETICS INC.":
                    if self.Ready(inst):
                        lineEditVisa.setText(visa_name)
                        selectClose[0].setEnabled(False)
                        selectClose[1].setEnabled(True)
                        ...
                        self.ui.label_condition.setText("Choose valid Magnet address")
                else:
                    self.ui.label_condition.setText("Choose valid Magnet address")
    ...
    def start(self):
        ...
        #Make Array
        array_M = self.array_M_builder(float(inputted_data[1][0]), float(inputted_data[1][2]), float(inputted_data[1][3]), inputted_data[1][4].upper())
        count = 0
    ...
    def Print_data(self, device, text):
        ...
        self.out0_3 = str(text[2])
        self.out0_4 = str(format(text[7], '.3f'))
        
        display_text = ""                
        display_text = display_text + "Time: " + self.out0_1 + " s\n"
        display_text = display_text + "Time Step: " + self.out0_2 + " s\n"
        display_text = display_text + "Set Field: " + self.out0_3 + " T\n"
        display_text = display_text + "Current Field: " + self.out0_4 + " T\n\n"
...
class Collect_data(QThread):
    ...
    def input(self, ui, instruments, curves, curveWidgets, go_on, inputted_data, array_lst, device_state, count, dsave, input_data):
        ...
        self.sweep_rate = float(self.Data[1][1])
        self.Yokogawa_ramp_step = float(self.Data[1][5])
        self.Yokogawa_collect_step = float(self.Data[1][6])
    ...
    def run(self):
        ...
        Magnet().Conf_ramp_rate_field(self.Magnet, self.sweep_rate)
        Magnet().Ramp(self.Magnet)
        ...
        for i in range(0, len(self.array_M)):
            if self.go_on:
                ...
                if not self.stop_collecting:
                    ...
                    Magnet().Conf_field(self.Magnet, float(self.array_M[i]))
                    Magnet().Ramp(self.Magnet)
                    temp_field = None
                    while temp_field != "Set":
                        while self.pause_collecting:
                            if self.stop_collecting:
                                ...
                                pass
                        time.sleep(0.1)
                        Magnet().Magnet_field(self.Magnet)
                        temp_field = float(Magnet().Read(self.Magnet))
                        # print temp_field
                        # print abs(temp_field - self.Array[temp])
                        if abs(temp_field - float(self.array_M[i])) < 1e-8:
                            curr_field = temp_field
                            temp_field = "Set"
                    
                    self.set_field = float(self.array_M[i])
    ...
    def Reading(self, device, input_volt, num, Round):
        ...
        if device == "Yokogawa1":
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa1", [self.total_during, self.during, self.set_field, input_volt, current, resistance, self.Data[2][15], self.curr_field])
            self.setup_plot(self.curveWidgets[0], self.curves[0], [self.Current1, self.Resistance1], [self.Data[2][15], "Current (A)", "Resistance (Ohms)"])
            self.Pre_dynamic_save(num, False, [current, resistance], 2, Round)
        # Device 2
        elif device == "Yokogawa2":
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa2", [self.total_during, self.during, self.set_field, input_volt, current, resistance, self.Data[3][15], self.curr_field])
            self.setup_plot(self.curveWidgets[1], self.curves[1], [self.Current2, self.Resistance2], [self.Data[3][15], "Current (A)", "Resistance (Ohms)"])
            self.Pre_dynamic_save(num, False, [current, resistance], 3, Round)
        # Device 3
        elif device == "Yokogawa3":
            ...
            self.emit(SIGNAL('print_value'), "Yokogawa3", [self.total_during, self.during, self.set_field, input_volt, current, resistance, self.Data[4][15], self.curr_field])
            self.setup_plot(self.curveWidgets[2], self.curves[2], [self.Current3, self.Resistance3], [self.Data[4][15], "Current (A)", "Resistance (Ohms)"])        
            self.Pre_dynamic_save(num, False, [current, resistance], 4, Round)
    ...
    def Pre_dynamic_save(self, num, is_last, data_lst, i, Round):
        if self.ui.checkBox_dsave.isChecked():
            ...
            # File_info
            # First is file name
            file_info.append(self.Data[i][15] + '_' + str(Round) + '_' + str(self.set_field) + 'T_' + self.dsave_filename)
            # csv file
            ...
            if is_last:
                ...
                if num == 0:
                    ...
                    temp = []
                    temp.append('Magnet Visa Address:')
                    temp.append(str(self.ui.comboBox_visa_7.currentText()))
                    comments.append(temp)
                    temp = []
                    temp.append('Magnet Visa Name:')
                    ...
                    comments.append(temp)
                    temp = []
                    temp.append('Set Magnet field (T):')
                    temp.append(str(self.set_field))
                    comments.append(temp)
                    temp = []
                    temp.append('Current Magnet field (T):')
                    temp.append(str(self.curr_field))
                    comments.append(temp)
